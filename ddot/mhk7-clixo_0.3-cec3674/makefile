...
clixo.o: clixo.cpp util.h dag.h graph_undirected.h dagConstruct.h graph_undirected_bitset.h nodeDistanceObject.h corrector.h
	$(CC) $(CFLAGS11) clixo.cpp

clustersToDAG: clustersToDAG.o
	$(CC) $(LFLAGS11) clustersToDAG.o -o clustersToDAG

clustersToDAG.o: clustersToDAG.cpp util.h dag.h graph_undirected.h dagConstruct.h graph_undirected_bitset.h nodeDistanceObject.h corrector.h
